...
build: src/pages/main.c src/pages/game_page.h src/pages/settings_page.h src/pages/welcome_page.h src/pages/state.h src/includes/data-structures/binary_tree.h
	@mkdir -p build/
